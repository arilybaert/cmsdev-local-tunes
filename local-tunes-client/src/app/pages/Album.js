...
const Playlist = () => {
    ...
    const { setAudioSrc, setPlayerSong, setPlayerArtist, setPlayerCover, setArtistId, setArtistLikeId } = useContext(LocalTunesContext);
    ...
    const fetchAlbum = async () => {
        await axios.get(
            ...
            setArtistLikeId(res.data.acf.artist.data.ID);
